...
function Calendar({
  ...
  captionLayout = "label",
  buttonVariant = "ghost",
  // Default es: toda la app es en español y ningún consumidor pasaba
  // locale explícito, así que el calendario quedaba en inglés (default de
  // react-day-picker). Un consumidor puede seguir pasando otro locale.
  locale = es,
  formatters,
  components,
  ...props
